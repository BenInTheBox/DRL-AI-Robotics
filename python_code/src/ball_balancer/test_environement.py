...
class TestEnv(gym.Env):
    ...
    def __init__(self, reward_func=linear_e_reward, reward_w=0.5):
        ...
        self.ema: np.ndarray = np.array([0.])
        self.ema_ema: np.ndarray = np.array([0.])
        self.real_error: np.ndarray = np.array([0.])
        self.real_d_error: np.ndarray = np.array([0.])
    ...
    def observe(self):
        ...
        obs[1] = (obs[1] - self.observation[1]) / DT
    ...
    def scaled_obs(self):
        ...
        observation[0] = self.observation[0] * BALL_ERROR_SCALING
        observation[1] = self.observation[1] * BALL_D_ERROR_SCALING
        observation[2] = self.observation[2] * BALL_INTEGRAL_ERROR_SCALING
        return observation
